    ...
    <div id="dingdanxiangqing_body_big">
     ...
     <div id="big_right" style="height: 500px;overflow: scroll;">
							    ...
							    <div class="modal-content">
									...
									<form action="userservlet?method=updateAddress" method="post" class="form-horizontal">
										...
										<div class="motal-footer">
											<button type="submit" class="btn btn-primary text-center" >修改</button>
										</div>
									</form>
								</div>
							</div>
		...
		<div class="container" style="width:960px;">
			...
			<form id="myform" action="userservlet?method=addAddress" method="post" class="form-horizontal">
				<div class="form-group">
				...
				<div class="form-group col-md-12">
					<input type="button" onclick="click1()" class="btn btn-primary" value="添加地址">
				</div>
			...
			<script>
				function click1(){
					$.post("userservlet?method=addAddress",$("#myform").serialize(),function (data){
						if(data.msg!="success"){
							alert(data.msg);
						}
						location="userservlet?method=getAddress"
					})
				}
			</script>
	      </div>
