			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
						<button type="button" class="btn btn-primary" id="search" onclick="location.href='${pageContext.request.contextPath}/goodsservlet?/method=getGoodsListBySearch&name='+$('input[name='name']').val()"><span class="glyphicon glyphicon-search"></span></button>
					</div>
				</div>
